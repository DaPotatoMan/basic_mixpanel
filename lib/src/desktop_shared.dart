/// Code taken from https://github.com/koa-health/mixpanel_analytics/blob/master/lib/src/mixpanel_analytics.dart
library;
...
class MixpanelAnalytics {
  ...
  final Map<String, List<dynamic>> _queuedEvents = {'track': [], 'engage': []};
  ...
  static String _defaultShaFn(String value) => value;
  ...
  Future<void> _restoreQueuedEventsFromStorage() async {
    ...
    if (encoded != null) {
      final events = json.decode(encoded) as Map<String, List<dynamic>>;
  ...
  Future<void> _uploadEvents(List<dynamic> events, Future<bool> Function(String event) sendFn) async {
    final List<dynamic> unsentEvents = [];
  ...
  Map<String, dynamic> _createTrackEvent(
    ...
    if (insertId != null) {
      properties = {...properties, r'$insert_id': insertId};
    }
  ...
  Map<String, dynamic> _createEngageEvent(
    ...
    if (ignoreTime != null) {
      data = {...data, r'$ignore_time': ignoreTime};
    }
    if (ignoreAlias != null) {
  ...
  Future<bool> _sendBatch(String batch, String op) async {
    var url = '$baseApiUrl/$op/?verbose=${_verbose ? 1 : 0}&ip=${_useIp ? 1 : 0}';
    if (_proxyUrl != null) {
      url = url.replaceFirst('https://', '');
      url = '$_proxyUrl/$url';
    }
...
extension UpdateOperationsExtension on MixpanelUpdateOperations {
  static const Map<MixpanelUpdateOperations, String> _updateOperations = {
    MixpanelUpdateOperations.$set: r'$set',
    MixpanelUpdateOperations.$setOnce: r'$set_once',
    MixpanelUpdateOperations.$add: r'$add',
    MixpanelUpdateOperations.$append: r'$append',
    MixpanelUpdateOperations.$union: r'$union',
    MixpanelUpdateOperations.$remove: r'$remove',
    MixpanelUpdateOperations.$unset: r'$unset',
    MixpanelUpdateOperations.$delete: r'$delete',
  };
